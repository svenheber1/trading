...
#property link "https://app.profectus.ai/Va7rUDaVKxxci-sgTjgO9PhXnnYbugdd?utm_source=share"
...
#property description "This project was shared on 25/09/2026 13:25."
#property description ""
#property description ""
#property description ""
...
input string Project_link = "https://app.profectus.ai/Va7rUDaVKxxci-sgTjgO9PhXnnYbugdd?utm_source=share";		// Project_link
...
//@PAI_BLOCK_BEGIN 0 OncePerBarDto_768d8e94-d120-42aa-b127-439467fa2c3b
OncePerBarBlockParams params0;
params0.period = Value<ENUM_TIMEFRAMES>(PERIOD_H4);
params0.maxPasses = Value<int>(1.0);
params0.index = 0;
params0.nextBlocks = "1";
params0.symbol = "";
b[0] = new OncePerBarBlock(params0);
//@PAI_BLOCK_END 0

//@PAI_BLOCK_BEGIN 1 5f8e2de1-ca65-4f73-b6a1-0621c70c3792
ConditionBlockParams<Candle, IndicatorBlock_iMA> params1;
params1.left_operand = new Candle("Close", Value<int>(1.0), Value<ENUM_TIMEFRAMES>(PERIOD_CURRENT));
params1.right_operand = new IndicatorBlock_iMA(Symbol(), Value<ENUM_TIMEFRAMES>(PERIOD_CURRENT), 0, Value<int>(1.0), Value<int>(10.0), Value<int>(0.0), MODE_EMA, PRICE_HIGH);
params1.compare_operator = ">";
params1.left_adjust_operation = '+';
params1.left_adjust_value =  Value<double>(0);
params1.right_adjust_operation = '+';
params1.right_adjust_value = Value<double>(0.0);
params1.nextBlocks = "5";
params1.falseBlocks = "-1";
params1.index = 1;
params1.contextCreatorIndex = -1;
b[1] = new ConditionBlock<Candle, IndicatorBlock_iMA>(params1);
//@PAI_BLOCK_END 1

//@PAI_BLOCK_BEGIN 2 TradeOrderCountDto_6fb2e557-1aca-43d1-82bc-0ba16bc295b0
CheckTradeAndOrderCountBlockParams checkTradeAndOrderCountBlockParams2;
checkTradeAndOrderCountBlockParams2.tradeOperator = "==";
checkTradeAndOrderCountBlockParams2.orderOperator = "==";
checkTradeAndOrderCountBlockParams2.tradeCount = Value<int>(0.0);
checkTradeAndOrderCountBlockParams2.orderCount = Value<int>(0.0);
checkTradeAndOrderCountBlockParams2.nextBlocks = "3";
checkTradeAndOrderCountBlockParams2.falseBlocks = "-1";
checkTradeAndOrderCountBlockParams2.index = 2;
checkTradeAndOrderCountBlockParams2.symbolsStr = "";
checkTradeAndOrderCountBlockParams2.groupIdsStr = "";
checkTradeAndOrderCountBlockParams2.tradeDirection = BUYS_ONLY;
b[2] = new CheckTradeAndOrderCountBlock(checkTradeAndOrderCountBlockParams2);
//@PAI_BLOCK_END 2

//@PAI_BLOCK_BEGIN 3 BuyNowDto_bb12d74f-2c72-470a-be71-6a448e006425
...
params3.stop_loss = new FixedStopLoss(Value<double>("input", "SL"), ActionType::BUY);
...
//@PAI_BLOCK_BEGIN 4 32c97c01-f024-440d-bad3-19977637ac1e
ConditionBlockParams<Candle, IndicatorBlock_iMA> params4;
params4.left_operand = new Candle("Close", Value<int>(1.0), Value<ENUM_TIMEFRAMES>(PERIOD_CURRENT));
params4.right_operand = new IndicatorBlock_iMA(Symbol(), Value<ENUM_TIMEFRAMES>(PERIOD_CURRENT), 0, Value<int>(1.0), Value<int>(20.0), Value<int>(0.0), MODE_EMA, PRICE_CLOSE);
...
params4.nextBlocks = "2";
params4.falseBlocks = "-1";
params4.index = 4;
params4.contextCreatorIndex = -1;
b[4] = new ConditionBlock<Candle, IndicatorBlock_iMA>(params4);
//@PAI_BLOCK_END 4

//@PAI_BLOCK_BEGIN 5 9d5e5f7f-be24-493c-b947-f9ac8d373a9e
ConditionBlockParams<Candle, IndicatorBlock_iMA> params5;
params5.left_operand = new Candle("Close", Value<int>(2.0), Value<ENUM_TIMEFRAMES>(PERIOD_CURRENT));
params5.right_operand = new IndicatorBlock_iMA(Symbol(), Value<ENUM_TIMEFRAMES>(PERIOD_CURRENT), 0, Value<int>(2.0), Value<int>(10.0), Value<int>(0.0), MODE_EMA, PRICE_HIGH);
...
params5.nextBlocks = "4";
params5.falseBlocks = "-1";
params5.index = 5;
params5.contextCreatorIndex = -1;
b[5] = new ConditionBlock<Candle, IndicatorBlock_iMA>(params5);
//@PAI_BLOCK_END 5
...
//<ProjectData></ProjectData>